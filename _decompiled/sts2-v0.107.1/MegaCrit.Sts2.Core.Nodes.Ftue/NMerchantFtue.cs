...
public class NMerchantFtue : NFtue
{
	...
	public new class MethodName : NFtue.MethodName
	{
		...
		/// </summary>
		public static readonly StringName CloseFtueAndOpenRug = "CloseFtueAndOpenRug";
	...
	public new class PropertyName : NFtue.PropertyName
	{
		...
		/// </summary>
		public static readonly StringName _sneakyHitbox = "_sneakyHitbox";
	...
	internal new static List<MethodInfo> GetGodotMethodList()
	{
		...
		{
			new PropertyInfo(Variant.Type.Object, "merchantRoom", PropertyHint.None, "", PropertyUsageFlags.Default, new StringName("Control"), exported: false)
		}, null));
		list.Add(new MethodInfo(MethodName.CloseFtueAndOpenRug, new PropertyInfo(Variant.Type.Nil, "", PropertyHint.None, "", PropertyUsageFlags.Default, exported: false), MethodFlags.Normal, new List<PropertyInfo>
		{
	...
	protected override bool InvokeGodotClassMethod(in godot_string_name method, NativeVariantPtrArgs args, out godot_variant ret)
	{
		...
		{
			ret = VariantUtils.CreateFrom<NMerchantFtue>(Create(VariantUtils.ConvertTo<NMerchantRoom>(in args[0])));
			return true;
		}
		if (method == MethodName.CloseFtueAndOpenRug && args.Count == 1)
		{
			CloseFtueAndOpenRug(VariantUtils.ConvertTo<NButton>(in args[0]));
			ret = default(godot_variant);
			return true;
		}
	...
	protected override bool HasGodotClassMethod(in godot_string_name method)
	{
		...
		if (method == MethodName.CloseFtueAndOpenRug)
		{
			return true;
		}
	...
	protected override bool SetGodotClassPropertyValue(in godot_string_name name, in godot_variant value)
	{
		...
		if (name == PropertyName._sneakyHitbox)
		{
			_sneakyHitbox = VariantUtils.ConvertTo<Control>(in value);
			return true;
		}
	...
	protected override bool GetGodotClassPropertyValue(in godot_string_name name, out godot_variant value)
	{
		...
		if (name == PropertyName._sneakyHitbox)
		{
			value = VariantUtils.CreateFrom(in _sneakyHitbox);
			return true;
		}
		if (name == PropertyName._merchantRoom)
		{
	...
	internal new static List<PropertyInfo> GetGodotPropertyList()
	{
		...
		list.Add(new PropertyInfo(Variant.Type.Object, PropertyName._sneakyHitbox, PropertyHint.None, "", PropertyUsageFlags.ScriptVariable, exported: false));
		list.Add(new PropertyInfo(Variant.Type.Object, PropertyName._merchantRoom, PropertyHint.None, "", PropertyUsageFlags.ScriptVariable, exported: false));
	...
	protected override void SaveGodotObjectData(GodotSerializationInfo info)
	{
		...
		info.AddProperty(PropertyName._sneakyHitbox, Variant.From(in _sneakyHitbox));
	...
	protected override void RestoreGodotObjectData(GodotSerializationInfo info)
	{
		...
		if (info.TryGetProperty(PropertyName._sneakyHitbox, out var value4))
		{
			_sneakyHitbox = value4.As<Control>();
		}
		if (info.TryGetProperty(PropertyName._merchantRoom, out var value5))
		{
			_merchantRoom = value5.As<NMerchantRoom>();
		}
		if (info.TryGetProperty(PropertyName._defaultZIndex, out var value6))
		{
			_defaultZIndex = value6.As<int>();
		}
	}
}
