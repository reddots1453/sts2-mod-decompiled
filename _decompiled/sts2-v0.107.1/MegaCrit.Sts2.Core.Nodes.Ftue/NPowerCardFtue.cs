...
public class NPowerCardFtue : NFtue
{
	...
	public new class PropertyName : NFtue.PropertyName
	{
		...
		/// </summary>
		public static readonly StringName _ftueHolder = "_ftueHolder";
	...
	protected override bool InvokeGodotClassMethod(in godot_string_name method, NativeVariantPtrArgs args, out godot_variant ret)
	{
		...
		{
			ret = VariantUtils.CreateFrom<NPowerCardFtue>(Create(VariantUtils.ConvertTo<Control>(in args[0])));
			return true;
		}
	...
	protected override bool SetGodotClassPropertyValue(in godot_string_name name, in godot_variant value)
	{
		...
		if (name == PropertyName._ftueHolder)
		{
			_ftueHolder = VariantUtils.ConvertTo<Control>(in value);
			return true;
		}
	...
	protected override bool GetGodotClassPropertyValue(in godot_string_name name, out godot_variant value)
	{
		...
		if (name == PropertyName._ftueHolder)
		{
			value = VariantUtils.CreateFrom(in _ftueHolder);
			return true;
		}
		if (name == PropertyName._defaultZIndex)
		{
	...
	internal new static List<PropertyInfo> GetGodotPropertyList()
	{
		...
		list.Add(new PropertyInfo(Variant.Type.Object, PropertyName._ftueHolder, PropertyHint.None, "", PropertyUsageFlags.ScriptVariable, exported: false));
	...
	protected override void SaveGodotObjectData(GodotSerializationInfo info)
	{
		...
		info.AddProperty(PropertyName._ftueHolder, Variant.From(in _ftueHolder));
	...
	protected override void RestoreGodotObjectData(GodotSerializationInfo info)
	{
		...
		if (info.TryGetProperty(PropertyName._card, out var value4))
		{
			_card = value4.As<Control>();
		}
		if (info.TryGetProperty(PropertyName._ftueHolder, out var value5))
		{
			_ftueHolder = value5.As<Control>();
		}
