...
public class NCombatRewardFtue : NFtue
{
	...
	internal new static List<MethodInfo> GetGodotMethodList()
	{
		...
		{
			new PropertyInfo(Variant.Type.Object, "rewardsContainer", PropertyHint.None, "", PropertyUsageFlags.Default, new StringName("Control"), exported: false)
		}, null));
	...
	protected override bool InvokeGodotClassMethod(in godot_string_name method, NativeVariantPtrArgs args, out godot_variant ret)
	{
		...
		{
			ret = VariantUtils.CreateFrom<NCombatRewardFtue>(Create(VariantUtils.ConvertTo<Control>(in args[0])));
			return true;
		}
	...
	protected override void RestoreGodotObjectData(GodotSerializationInfo info)
	{
		...
		if (info.TryGetProperty(PropertyName._rewardsContainer, out var value4))
		{
			_rewardsContainer = value4.As<Control>();
		}
