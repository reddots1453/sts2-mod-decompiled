...
public class NCannotPlayCardFtue : NFtue
{
	...
	public new class MethodName : NFtue.MethodName
	{
		...
		/// </summary>
		public static readonly StringName CloseFtueAndEndTurn = "CloseFtueAndEndTurn";
	...
	internal new static List<MethodInfo> GetGodotMethodList()
	{
		...
		list.Add(new MethodInfo(MethodName.CloseFtueAndEndTurn, new PropertyInfo(Variant.Type.Nil, "", PropertyHint.None, "", PropertyUsageFlags.Default, exported: false), MethodFlags.Normal, new List<PropertyInfo>
		{
	...
	protected override bool InvokeGodotClassMethod(in godot_string_name method, NativeVariantPtrArgs args, out godot_variant ret)
	{
		...
		{
			ret = VariantUtils.CreateFrom<NCannotPlayCardFtue>(Create());
			return true;
		}
		if (method == MethodName.CloseFtueAndEndTurn && args.Count == 1)
		{
			CloseFtueAndEndTurn(VariantUtils.ConvertTo<NButton>(in args[0]));
			ret = default(godot_variant);
			return true;
		}
	...
	protected override bool HasGodotClassMethod(in godot_string_name method)
	{
		...
		if (method == MethodName.CloseFtueAndEndTurn)
		{
			return true;
		}
