...
[ScriptPath("res://src/Core/Nodes/Screens/Map/NMapEraseButton.cs")]
public class NMapEraseButton : NButton
{
	/// <summary>
	...
	public new class MethodName : NButton.MethodName
	{
		...
		/// </summary>
		public static readonly StringName SetIsErasing = "SetIsErasing";
	...
	public new class PropertyName : NButton.PropertyName
	{
		...
		/// </summary>
		public static readonly StringName _isErasing = "_isErasing";
	}
	...
	protected override void OnFocus()
	{
		...
		NHoverTipSet.CreateAndShow(_drawingToolHolder, _hoverTip)?.SetGlobalPosition(_drawingToolHolder.GlobalPosition + new Vector2(10f, -132f));
	}
	...
	internal new static List<MethodInfo> GetGodotMethodList()
	{
		...
		list.Add(new MethodInfo(MethodName.SetIsErasing, new PropertyInfo(Variant.Type.Nil, "", PropertyHint.None, "", PropertyUsageFlags.Default, exported: false), MethodFlags.Normal, new List<PropertyInfo>
		{
			new PropertyInfo(Variant.Type.Bool, "isErasing", PropertyHint.None, "", PropertyUsageFlags.Default, exported: false)
		}, null));
	...
	protected override bool InvokeGodotClassMethod(in godot_string_name method, NativeVariantPtrArgs args, out godot_variant ret)
	{
		...
		if (method == MethodName.SetIsErasing && args.Count == 1)
		{
			SetIsErasing(VariantUtils.ConvertTo<bool>(in args[0]));
			ret = default(godot_variant);
			return true;
		}
	...
	protected override bool HasGodotClassMethod(in godot_string_name method)
	{
		...
		if (method == MethodName.SetIsErasing)
		{
			return true;
		}
	...
	protected override bool SetGodotClassPropertyValue(in godot_string_name name, in godot_variant value)
	{
		...
		if (name == PropertyName._isErasing)
		{
			_isErasing = VariantUtils.ConvertTo<bool>(in value);
			return true;
		}
	...
	protected override bool GetGodotClassPropertyValue(in godot_string_name name, out godot_variant value)
	{
		...
		if (name == PropertyName._isErasing)
		{
			value = VariantUtils.CreateFrom(in _isErasing);
			return true;
		}
	...
	internal new static List<PropertyInfo> GetGodotPropertyList()
	{
		...
		list.Add(new PropertyInfo(Variant.Type.Bool, PropertyName._isErasing, PropertyHint.None, "", PropertyUsageFlags.ScriptVariable, exported: false));
		return list;
	}
	...
	protected override void SaveGodotObjectData(GodotSerializationInfo info)
	{
		...
		info.AddProperty(PropertyName._isErasing, Variant.From(in _isErasing));
	}
	...
	protected override void RestoreGodotObjectData(GodotSerializationInfo info)
	{
		...
		if (info.TryGetProperty(PropertyName._isErasing, out var value4))
		{
			_isErasing = value4.As<bool>();
		}
	}
}
