...
public sealed class CaptainsWheel : RelicModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::_003C_003Ez__ReadOnlySingleElementList<DynamicVar>(new BlockVar(18m, ValueProp.Unpowered));
