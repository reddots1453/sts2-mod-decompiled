...
public class NDesaturateTransitionVfx : Node
{
	...
	public new class MethodName : Node.MethodName
	{
		...
		/// </summary>
		public static readonly StringName Animate = "Animate";
	}
	...
	internal static List<MethodInfo> GetGodotMethodList()
	{
		...
		list.Add(new MethodInfo(MethodName.Create, new PropertyInfo(Variant.Type.Object, "", PropertyHint.None, "", PropertyUsageFlags.Default, new StringName("Node"), exported: false), MethodFlags.Normal | MethodFlags.Static, null, null));
		list.Add(new MethodInfo(MethodName._Ready, new PropertyInfo(Variant.Type.Nil, "", PropertyHint.None, "", PropertyUsageFlags.Default, exported: false), MethodFlags.Normal, null, null));
		list.Add(new MethodInfo(MethodName._ExitTree, new PropertyInfo(Variant.Type.Nil, "", PropertyHint.None, "", PropertyUsageFlags.Default, exported: false), MethodFlags.Normal, null, null));
		list.Add(new MethodInfo(MethodName.Animate, new PropertyInfo(Variant.Type.Nil, "", PropertyHint.None, "", PropertyUsageFlags.Default, exported: false), MethodFlags.Normal, null, null));
		return list;
	}
	...
	protected override bool InvokeGodotClassMethod(in godot_string_name method, NativeVariantPtrArgs args, out godot_variant ret)
	{
		...
		{
			ret = VariantUtils.CreateFrom<NDesaturateTransitionVfx>(Create());
			return true;
		}
		...
		if (method == MethodName.Animate && args.Count == 0)
		{
			Animate();
			ret = default(godot_variant);
			return true;
