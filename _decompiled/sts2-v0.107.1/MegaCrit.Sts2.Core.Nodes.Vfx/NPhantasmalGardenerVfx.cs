...
public class NPhantasmalGardenerVfx : Node
{
	...
	public new class MethodName : Node.MethodName
	{
		...
		/// </summary>
		public static readonly StringName OnSpewStart = "OnSpewStart";

		/// <summary>
		/// Cached name for the 'OnSpewEnd' method.
		/// </summary>
		public static readonly StringName OnSpewEnd = "OnSpewEnd";
	}
	...
	public new class PropertyName : Node.PropertyName
	{
		...
		/// </summary>
		public static readonly StringName _spewParticles = "_spewParticles";
	}
	...
	internal static List<MethodInfo> GetGodotMethodList()
	{
		...
		list.Add(new MethodInfo(MethodName.OnSpewStart, new PropertyInfo(Variant.Type.Nil, "", PropertyHint.None, "", PropertyUsageFlags.Default, exported: false), MethodFlags.Normal, null, null));
		list.Add(new MethodInfo(MethodName.OnSpewEnd, new PropertyInfo(Variant.Type.Nil, "", PropertyHint.None, "", PropertyUsageFlags.Default, exported: false), MethodFlags.Normal, null, null));
		return list;
	}
	...
	protected override bool InvokeGodotClassMethod(in godot_string_name method, NativeVariantPtrArgs args, out godot_variant ret)
	{
		...
		if (method == MethodName.OnSpewStart && args.Count == 0)
		{
			OnSpewStart();
			ret = default(godot_variant);
			return true;
		}
		if (method == MethodName.OnSpewEnd && args.Count == 0)
		{
			OnSpewEnd();
			ret = default(godot_variant);
			return true;
	...
	protected override bool HasGodotClassMethod(in godot_string_name method)
	{
		...
		if (method == MethodName.OnSpewStart)
		{
			return true;
		}
		if (method == MethodName.OnSpewEnd)
		{
			return true;
		}
	...
	{
		if (name == PropertyName._spewParticles)
		{
			_spewParticles = VariantUtils.ConvertTo<GpuParticles2D>(in value);
			return true;
		}
	...
	protected override bool GetGodotClassPropertyValue(in godot_string_name name, out godot_variant value)
	{
		if (name == PropertyName._spewParticles)
		{
			value = VariantUtils.CreateFrom(in _spewParticles);
			return true;
		}
	...
	internal static List<PropertyInfo> GetGodotPropertyList()
	{
		...
		list.Add(new PropertyInfo(Variant.Type.Object, PropertyName._spewParticles, PropertyHint.None, "", PropertyUsageFlags.ScriptVariable, exported: false));
		return list;
	}
	...
	protected override void SaveGodotObjectData(GodotSerializationInfo info)
	{
		...
		info.AddProperty(PropertyName._spewParticles, Variant.From(in _spewParticles));
	}
	...
	protected override void RestoreGodotObjectData(GodotSerializationInfo info)
	{
		...
		if (info.TryGetProperty(PropertyName._spewParticles, out var value))
		{
			_spewParticles = value.As<GpuParticles2D>();
		}
	}
}
