...
public class NPoisonImpactVfx : Node2D
{
	...
	public new class PropertyName : Node2D.PropertyName
	{
		...
		/// </summary>
		public static readonly StringName _horizontalSmokeContainer = "_horizontalSmokeContainer";
	}
	...
	protected override bool InvokeGodotClassMethod(in godot_string_name method, NativeVariantPtrArgs args, out godot_variant ret)
	{
		...
		{
			ret = VariantUtils.CreateFrom<NPoisonImpactVfx>(Create(VariantUtils.ConvertTo<Vector2>(in args[0])));
			return true;
		}
	...
	protected override bool SetGodotClassPropertyValue(in godot_string_name name, in godot_variant value)
	{
		...
		if (name == PropertyName._horizontalSmokeContainer)
		{
			_horizontalSmokeContainer = VariantUtils.ConvertTo<Node2D>(in value);
			return true;
		}
	...
	protected override bool GetGodotClassPropertyValue(in godot_string_name name, out godot_variant value)
	{
		...
		if (name == PropertyName._horizontalSmokeContainer)
		{
			value = VariantUtils.CreateFrom(in _horizontalSmokeContainer);
			return true;
		}
	...
	internal static List<PropertyInfo> GetGodotPropertyList()
	{
		...
		list.Add(new PropertyInfo(Variant.Type.Object, PropertyName._horizontalSmokeContainer, PropertyHint.NodeType, "Node2D", PropertyUsageFlags.Default | PropertyUsageFlags.ScriptVariable, exported: true));
		return list;
	}
	...
	protected override void SaveGodotObjectData(GodotSerializationInfo info)
	{
		...
		info.AddProperty(PropertyName._horizontalSmokeContainer, Variant.From(in _horizontalSmokeContainer));
	}
	...
	protected override void RestoreGodotObjectData(GodotSerializationInfo info)
	{
		...
		if (info.TryGetProperty(PropertyName._horizontalSmokeContainer, out var value2))
		{
			_horizontalSmokeContainer = value2.As<Node2D>();
		}
	}
}
