...
public class NBattlewornDummyVfx : Node
{
	...
	public new class MethodName : Node.MethodName
	{
		...
		/// </summary>
		public static readonly StringName OnDamageChips = "OnDamageChips";
	}
	...
	internal static List<MethodInfo> GetGodotMethodList()
	{
		...
		list.Add(new MethodInfo(MethodName.OnDamageChips, new PropertyInfo(Variant.Type.Nil, "", PropertyHint.None, "", PropertyUsageFlags.Default, exported: false), MethodFlags.Normal, null, null));
		return list;
	}
	...
	protected override bool InvokeGodotClassMethod(in godot_string_name method, NativeVariantPtrArgs args, out godot_variant ret)
	{
		...
		if (method == MethodName.OnDamageChips && args.Count == 0)
		{
			OnDamageChips();
			ret = default(godot_variant);
			return true;
	...
	protected override bool HasGodotClassMethod(in godot_string_name method)
	{
		...
		if (method == MethodName.OnDamageChips)
		{
			return true;
		}
	...
	protected override void RestoreGodotObjectData(GodotSerializationInfo info)
	{
		...
		if (info.TryGetProperty(PropertyName._damageParticles, out var value))
		{
			_damageParticles = value.As<GpuParticles2D>();
		}
	}
}
