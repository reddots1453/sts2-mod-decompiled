...
public class NCardCostTickbox : NButton
{
	...
	protected override void RestoreGodotObjectData(GodotSerializationInfo info)
	{
		...
		if (info.TryGetProperty(PropertyName._hoverV, out var value10))
		{
			_hoverV = value10.As<float>();
		}
		if (info.TryGetProperty(PropertyName._hoverScale, out var value11))
		{
			_hoverScale = value11.As<float>();
		}
		if (info.TryGetProperty(PropertyName._pressDownScale, out var value12))
		{
			_pressDownScale = value12.As<float>();
		}
	}
}
