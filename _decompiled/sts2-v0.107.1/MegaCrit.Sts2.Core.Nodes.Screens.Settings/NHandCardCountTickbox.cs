...
public class NHandCardCountTickbox : NSettingsTickbox, IResettableSettingNode
{
	...
	public new class MethodName : NSettingsTickbox.MethodName
	{
		...
		/// </summary>
		public static readonly StringName TryRefreshHandIndices = "TryRefreshHandIndices";
	}
	...
	internal new static List<MethodInfo> GetGodotMethodList()
	{
		...
		list.Add(new MethodInfo(MethodName.TryRefreshHandIndices, new PropertyInfo(Variant.Type.Nil, "", PropertyHint.None, "", PropertyUsageFlags.Default, exported: false), MethodFlags.Normal | MethodFlags.Static, null, null));
		return list;
	}
	...
	protected override bool InvokeGodotClassMethod(in godot_string_name method, NativeVariantPtrArgs args, out godot_variant ret)
	{
		...
		if (method == MethodName.TryRefreshHandIndices && args.Count == 0)
		{
			TryRefreshHandIndices();
			ret = default(godot_variant);
			return true;
	...
	protected override bool HasGodotClassMethod(in godot_string_name method)
	{
		...
		if (method == MethodName.TryRefreshHandIndices)
		{
			return true;
		}
