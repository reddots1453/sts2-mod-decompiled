...
public static class L
{
    ...
    private static readonly Dictionary<string, string> CN = new()
    {
        ...
        ["contrib.help_color_osty"] = "Osty（亡灵契约师召唤物）",
        ["contrib.help_color_modifier"] = "修正加成（力量 / 易伤 / 金刚杵 等）",
        ["contrib.help_color_attributed"] = "归因间接伤害（中毒 / 灼烧 等 power tick）",
        ["contrib.help_color_mitigate"] = "减免（虚弱 debuff 加在敌人身上）",
        ["contrib.help_color_strdown"] = "降低敌人力量（萎靡 / 黑色枷锁）",
        ["contrib.help_color_self"] = "自伤（献祭 / 放血）",
        ["contrib.help_direct"] = "直接伤害：卡牌本身打出造成的 HP 损失",
        ["contrib.help_modifier"] = "修正伤害：因力量/灵活/金刚杵等修正而多出的伤害 — 归属到施加该修正的来源",
        ["contrib.help_attributed"] = "归因伤害：power tick (中毒、灼烧、尖刺) 造成的伤害 — 归属到施加该 power 的来源",
        ["contrib.help_block"] = "有效格挡：被来源卡的格挡叠加吸收的伤害",
        ["contrib.help_mitigated"] = "减免：被虚弱 / 缓冲 / 虚无 等阻挡的伤害 — 归属到施加该效果的来源",
        ["contrib.help_str_reduce"] = "削力减伤：因削减敌人力量而少受到的伤害",
        ["contrib.help_self"] = "自伤：献祭/放血等卡造成的 HP 损失。显示为红条但不计入防御 % 分母，避免出现 >100% 的情况",
        ["contrib.help_energy"] = "能量获取：来源额外获得（或节省）的能量",
        ["contrib.help_heal"] = "HP 治疗：来源恢复 HP 或获得最大 HP",
        ["contrib.help_draw"] = "抽牌：超出回合开始 5 张以外的额外抽牌",
        ["contrib.help_stars"] = "辉星贡献：来源累积的辉星点数（储君角色）",
        ...
        ["contrib.help_hotkeys"] = "快捷键：F8 切换面板，F9 设置，拖拽标题栏移动位置",
