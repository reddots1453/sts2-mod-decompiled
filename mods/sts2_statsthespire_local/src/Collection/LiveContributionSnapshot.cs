...
public sealed class LiveContributionSnapshot
{
    ...
    /// <summary>
    /// Per-encounter records from RunContributionAggregator.
    /// Restored on hydrate so TotalRunTurns survives save+quit.
    /// </summary>
    public List<RunContributionAggregator.EncounterRecord>? Encounters { get; set; }
}
