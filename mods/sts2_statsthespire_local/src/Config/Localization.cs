...
public static class L
{
    ...
    private static readonly Dictionary<string, string> EN = new()
    {
        ...
        ["career.recent_runs_all"] = "All",
        ["career.recent_runs_last_n"] = "Last N Runs",
        ["career.recent_runs_input_hint"] = "Number of recent runs to include",
    ...
    private static readonly Dictionary<string, string> CN = new()
    {
        ...
        ["career.recent_runs_all"] = "全部",
        ["career.recent_runs_last_n"] = "最近N局（输入数字）",
        ["career.recent_runs_input_hint"] = "输入最近对局数",
