...
public partial class CardDropOddsIndicator : Control
{
    ...
    private void ShowHoverPanel()
    {
        ...
        _hoverPanel = InfoModPanel.Create(Loc.Get("carddrop.title"), Loc.Get("carddrop.subtitle"));
        ...
        AddHeaderRow();
        AddTableRow(Loc.Get("carddrop.rare"), regularRare, eliteRare, GoldColor);
        AddTableRow(Loc.Get("carddrop.uncommon"), regularUncommon, eliteUncommon, AquaColor);
        AddTableRow(Loc.Get("carddrop.common"), regularCommon, eliteCommon, CreamColor);
    ...
    private void AddHeaderRow()
    {
        ...
        var reg = new Label { Text = Loc.Get("carddrop.col_regular") };
        ...
        var eli = new Label { Text = Loc.Get("carddrop.col_elite") };
